...
def main():
    ...
    if st.checkbox("--About Me--"):
        ...
        #st.write(e)
        st.write(''' ***Built by Rahman Alam***  ''') 
        st.write(''' ***Instagram*** : https://www.instagram.com/mr.________perfectionist/ ''')
        st.write(''' ***Linkedin*** : https://www.linkedin.com/in/rahman-a-09901082/ ''')
        st.write(''' ***Github*** : https://github.com/KAJURAMBO/ ''')
